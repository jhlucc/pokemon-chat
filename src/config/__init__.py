...
class Config(SimpleConfig):
    ...
    def __init__(self):
        ...
        self.add_item("enable_mcp", default=False, des="是否开启 MCP")
        # 模型配置
        ...
        self.add_item("embed_model", default="local/bge-large-zh-v1.5", des="Embedding 模型", choices=list(self.embed_model_names.keys()))
