...
class TestHybridSearch(unittest.TestCase):
    ...
    def test_hybrid_search_logic(self, MockUtility, MockCollection, MockConnections):
        ...
        # Init Store
        store = VectorStore(collection_name="test_hybrid", embedding_model=MockHybridEmbedding(), overwrite=True)
        ...
        # Execute
        results = store.hybrid_search(query="Pikachu", sparse_embedding={1: 0.5, 2: 0.3})
