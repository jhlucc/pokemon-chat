...
class MilvusService:
    def __init__(
        ...
        reranker_local_path: str | None = None,
        ...
        self.embedder = OpenAIEmbeddings(
            model=embedding_model, openai_api_base=openai_base_url, openai_api_key=openai_api_key, chunk_size=32
        )
        self.reranker = RerankerWrapper(
            reranker_key=reranker_key, model_name=reranker_model, local_path=reranker_local_path, device="cpu"
        )
        # 定义集合结构
        self.fields = [
        ...
        self.schema = CollectionSchema(
            fields=self.fields, description="LangChain Documents with OpenAI Embeddings", enable_dynamic_field=True
        )
    ...
    def insert_documents(self, documents: list[Document], batch_size: int = 32):
        ...
        for i in range(0, total_docs, batch_size):
            ...
            # 插入批次数据
            entities = [texts, embeddings, metadatas, text_length]
    ...
    def similarity_search(self, query: str, k: int = 3, rerank: bool = True, **search_kwargs) -> list[Document]:
        # 生成查询嵌入
        ...
        # 搜索参数
        search_params = {"metric_type": "COSINE", "params": {"nprobe": 8, "ef": 64}, **search_kwargs}
...
if __name__ == "__main__":
    ...
    docs = [
        Document(
            ...
            metadata={
                "uuid": "e8926baa84557853ea8df3288161e77c",
                ...
                "link": "https://www.pokemon.cn/play/pokedex/0025",
                "score": 0.04201680672268904,
            },
        ),
        Document(
            ...
            metadata={
                "uuid": "27998f19ce9eeee669d077a9546a9c78",
                ...
                "link": "https://tw.portal-pokemon.com/play/pokedex/0025",
                "score": 0.03361344537815125,
            },
        ),
        Document(
        ...
        Document(
            page_content="天气晴朗，适合郊游或者在公园散步。", metadata={"uuid": "test-004", "title": "天气与出行"}
        ),
        Document(
