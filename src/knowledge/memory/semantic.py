...
class SemanticMemoryManager:
    def __init__(self, collection_name: str = "pokemon_chat_memory"):
        ...
        self.embeddings = OpenAIEmbeddings(
            model="text-embedding-3-small", api_key=settings.llm.api_key, base_url=settings.llm.api_base
        )
    ...
    async def search_memory(self, query: str, k: int = 3, filter: dict | None = None) -> list[Document]:
    ...
    def search_memory_sync(self, query: str, k: int = 3, filter: dict | None = None) -> list[Document]:
